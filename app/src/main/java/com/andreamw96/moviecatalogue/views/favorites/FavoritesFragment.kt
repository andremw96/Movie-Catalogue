...
import com.andreamw96.moviecatalogue.views.common.ViewPagerAdapter
...
class FavoritesFragment : DaggerFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //adding fragments
        viewPagerAdapter.addFragment(FavoriteMoviesFragment(), getString(R.string.movies))
        viewPagerAdapter.addFragment(FavoriteTvShowsFragment(), getString(R.string.tv_shows))
